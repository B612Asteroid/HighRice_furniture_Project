...
<style type="text/css">
a{
   font-family: 고딕; font-size:15pt; font-weight: bold ; text-decoration: none;
...
<body>
   <div style="margin: 0 15% 0 15%; padding: 40px 0 40px 0; ">
      <div style="width: 40%; float: left;">
         <a href="main.jsp"><img src="img/logo.png" style="width: auto; height: 100px;"></a>
      </div>
      <div style="width: 60%; float: right; text-align: left; color: white;">
         <div style="width: 20%; float: right;">
            ...
            <c:if test="${sessionScope.id!=null}"><br></c:if>
            <c:if test="${sessionScope.id==null}">
               <a href="join.do">JOIN</a><br>
            </c:if>
               <a class="chk_login" value="myPage.do">MYPAGE</a><br>
            <a class="chk_login" value="cartList.do">CART</a><br>
            <a href="productList.do">ADMIN</a><br>
         </div>
         <div style="width: 20%; float: right;">
         ...
         <div style="width: 20%; float: right;">
            ...
            <a href="product.do?item=BED">BED</a><br>
            <a href="product.do?item=SOFA">SOFA</a><br>
            <a href="product.do?item=CLOSET">CLOSET</a><br>
            <a href="product.do?item=DESK">DESK</a><br>
         </div>
      </div>
   </div>
</body>
